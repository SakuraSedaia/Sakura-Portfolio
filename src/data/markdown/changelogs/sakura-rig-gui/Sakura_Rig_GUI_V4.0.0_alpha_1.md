...
standardized development practices to ensure compatibility across multiple Sakura rig versions without property
pollution or conflicts.

Key architectural shifts include moving UI properties from the global `Scene` and local `PoseBone` to individual
