...
This version brings about many architectural changes, mainly in the way that Modules are loaded, registered, and
structured, as well as new features, a new UI Script for the latest SACR Version, and a Skin Download Utility to make
getting Minecraft Skins much easier.
...
- Added an Else case for if Online Access is disabled
...
- Version 1 of the R7 GUI will no longer recieve updates from this point on, except to ensure continued compatability
