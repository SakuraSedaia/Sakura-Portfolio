      ...
      <div class="sr-gui-container body-content">
        ...
        <div class="content-1">
            ...
            <div class="download-gui">
              ...
              <a class="btn" href="https://github.com/SakuraSedaia/Sakura-Rig-GUI/releases/download/SR_GUI_V1.1.0/Sakura_Rig_GUI_V1_2_0.zip" target="_blank">Download Rig GUI Addon</a>
            </div>
        </div>
      </div>
    </div>
